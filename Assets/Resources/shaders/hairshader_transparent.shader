			...
			Program "fp" {
				SubProgram "d3d11 " {
					...
					void main()
					{
					    ...
					    u_xlat6.x = dot(vs_TEXCOORD1.xyz, u_xlat10_3.xyz);
					    u_xlat6.y = dot(vs_TEXCOORD2.xyz, u_xlat10_3.xyz);
					    u_xlat6.z = dot(vs_TEXCOORD3.xyz, u_xlat10_3.xyz);
					    ...
					    if(u_xlatb45){
					        ...
					        if(u_xlatb45){
					            ...
					            u_xlat9.xyz = u_xlat18.xyz * vec3(u_xlat45);
					            ...
					            u_xlat18.xyz = u_xlat9.xyz * vec3(u_xlat45) + u_xlat0.xyz;
					        //ENDIF
					        }
				...
				SubProgram "d3d11 " {
					...
					void main()
					{
					    ...
					    u_xlat16_46 = (-u_xlat16_20) * 0.699999988 + 1.70000005;
					    u_xlat16_46 = u_xlat16_46 * u_xlat16_20;
					    ...
					    u_xlat16_0.xyz = u_xlat10_4.xyz + vec3(-0.220916301, -0.220916301, -0.220916301);
					    u_xlat0.xyz = vec3(_Float0) * u_xlat16_0.xyz + vec3(0.220916301, 0.220916301, 0.220916301);
					    u_xlat46 = (-_Float0) * 0.779083729 + 0.779083729;
					    u_xlat4.xyz = vec3(u_xlat46) * u_xlat10_4.xyz;
					    ...
					    u_xlat16 = dot(vec2(u_xlat16), vec2(u_xlat16_20));
					    ...
					    u_xlat3.x = abs(u_xlat45) * u_xlat16_47 + u_xlat16_31;
					    ...
					    u_xlat3.x = u_xlat17 * u_xlat16_47 + (-u_xlat17);
					    ...
					    u_xlat16_31 = (-u_xlat16_31) * u_xlat16_20 + 1.0;
					    u_xlat2.x = dot(u_xlat0.xyz, u_xlat0.xyz);
					    u_xlatb2 = u_xlat2.x!=0.0;
					    u_xlat2.x = u_xlatb2 ? 1.0 : float(0.0);
				...
				SubProgram "d3d11 " {
					...
					void main()
					{
					    ...
					    if(u_xlatb44){
					        ...
					        u_xlat19.xyz = (bool(u_xlatb45)) ? u_xlat19.xyz : u_xlat1.xyz;
					        ...
					        u_xlat6.x = max(u_xlat45, u_xlat19.x);
					        u_xlat6 = texture(unity_ProbeVolumeSH, u_xlat6.xzw);
					    } else {
					    ...
					    u_xlat16_3 = (-u_xlat10_5.x) + 1.0;
					    u_xlat17.x = dot((-u_xlat2.xyz), u_xlat6.xyz);
					    u_xlat17.x = u_xlat17.x + u_xlat17.x;
					    u_xlat19.xyz = u_xlat6.xyz * (-u_xlat17.xxx) + (-u_xlat2.xyz);
					    ...
					    if(u_xlatb44){
					        ...
					        u_xlat44 = max(u_xlat44, u_xlat21);
					        u_xlat7.x = min(u_xlat8.x, u_xlat44);
					        ...
					        u_xlat6.w = 1.0;
					        u_xlat8.x = dot(unity_Builtins2Array.unity_Builtins2Array.unity_SHArArray, u_xlat6);
					        u_xlat8.y = dot(unity_Builtins2Array.unity_Builtins2Array.unity_SHAgArray, u_xlat6);
					        u_xlat8.z = dot(unity_Builtins2Array.unity_Builtins2Array.unity_SHAbArray, u_xlat6);
					    //ENDIF
					    }
					    ...
					    if(u_xlatb0){
					        ...
					        u_xlat0 = inversesqrt(u_xlat0);
					        u_xlat8.xyz = vec3(u_xlat0) * u_xlat19.xyz;
					        ...
					        u_xlat0 = min(u_xlat9.y, u_xlat9.x);
					        u_xlat0 = min(u_xlat9.z, u_xlat0);
					        u_xlat9.xyz = u_xlat1.xyz + (-unity_SpecCube0_ProbePosition.xyz);
					        u_xlat8.xyz = u_xlat8.xyz * vec3(u_xlat0) + u_xlat9.xyz;
					    } else {
					        u_xlat8.xyz = u_xlat19.xyz;
					    //ENDIF
					    }
					    u_xlat16_0 = (-u_xlat16_3) * 0.699999988 + 1.70000005;
					    u_xlat16_0 = u_xlat16_0 * u_xlat16_3;
					    u_xlat0 = u_xlat16_0 * 6.0;
					    u_xlat10_8 = textureLod(unity_SpecCube0, u_xlat8.xyz, u_xlat0);
					    ...
					    if(u_xlatb48){
					        ...
					        if(u_xlatb48){
					            ...
					            u_xlat19.xyz = u_xlat10.xyz * vec3(u_xlat48) + u_xlat1.xyz;
					        //ENDIF
					        }
					        u_xlat10_10 = textureLod(unity_SpecCube1, u_xlat19.xyz, u_xlat0);
					        u_xlat16_0 = u_xlat10_10.w + -1.0;
					        u_xlat0 = unity_SpecCube1_HDR.w * u_xlat16_0 + 1.0;
					        u_xlat0 = u_xlat0 * unity_SpecCube1_HDR.x;
					        u_xlat1.xyz = u_xlat10_10.xyz * vec3(u_xlat0);
					        u_xlat19.xyz = vec3(u_xlat44) * u_xlat10_8.xyz + (-u_xlat1.xyz);
					        u_xlat9.xyz = unity_SpecCube0_BoxMin.www * u_xlat19.xyz + u_xlat1.xyz;
					    //ENDIF
					    }
					    u_xlat16_1.xyz = u_xlat10_4.xyz + vec3(-0.220916301, -0.220916301, -0.220916301);
					    u_xlat1.xyz = vec3(_Float0) * u_xlat16_1.xyz + vec3(0.220916301, 0.220916301, 0.220916301);
					    u_xlat0 = (-_Float0) * 0.779083729 + 0.779083729;
					    u_xlat4.xyz = vec3(u_xlat0) * u_xlat10_4.xyz;
					    ...
					    u_xlat28 = dot(vec2(u_xlat28), vec2(u_xlat16_3));
					    ...
					    u_xlat16_42 = u_xlat16_3 * u_xlat16_3;
					    u_xlat16_42 = max(u_xlat16_42, 0.00200000009);
					    u_xlat16_44 = (-u_xlat16_42) + 1.0;
					    u_xlat19.x = abs(u_xlat43) * u_xlat16_44 + u_xlat16_42;
					    u_xlat44 = u_xlat2.x * u_xlat16_44 + u_xlat16_42;
					    u_xlat43 = abs(u_xlat43) * u_xlat44;
					    u_xlat43 = u_xlat2.x * u_xlat19.x + u_xlat43;
					    u_xlat43 = u_xlat43 + 9.99999975e-06;
					    u_xlat43 = 0.5 / u_xlat43;
					    u_xlat16_44 = u_xlat16_42 * u_xlat16_42;
					    u_xlat19.x = u_xlat16 * u_xlat16_44 + (-u_xlat16);
					    u_xlat16 = u_xlat19.x * u_xlat16 + 1.0;
					    ...
					    u_xlat16_42 = u_xlat16_42 * 0.280000001;
					    u_xlat16_42 = (-u_xlat16_42) * u_xlat16_3 + 1.0;
					    ...
					    u_xlat2.xyw = u_xlat17.xyz * vec3(u_xlat28) + u_xlat7.xyz;
					    u_xlat3.xyz = u_xlat17.xyz * vec3(u_xlat43);
					    u_xlat14.x = (-u_xlat14.x) + 1.0;
					    u_xlat28 = u_xlat14.x * u_xlat14.x;
					    u_xlat28 = u_xlat28 * u_xlat28;
					    u_xlat14.x = u_xlat14.x * u_xlat28;
					    u_xlat5.xyz = (-u_xlat1.xyz) + vec3(1.0, 1.0, 1.0);
					    u_xlat5.xyz = u_xlat5.xyz * u_xlat14.xxx + u_xlat1.xyz;
					    u_xlat3.xyz = u_xlat3.xyz * u_xlat5.xyz;
					    u_xlat2.xyw = u_xlat4.xyz * u_xlat2.xyw + u_xlat3.xyz;
					    u_xlat14.xyz = u_xlat9.xyz * vec3(u_xlat16_42);
			...
			Program "fp" {
				SubProgram "d3d11 " {
					...
					void main()
					{
					    ...
					    u_xlat6.xyz = vec3(_Float0) * u_xlat16_6.xyz + vec3(0.220916301, 0.220916301, 0.220916301);
					    u_xlat22 = (-_Float0) * 0.779083729 + 0.779083729;
					    u_xlat4.xyz = vec3(u_xlat22) * u_xlat10_4.xyz;
					    u_xlat16_22 = (-u_xlat10_5.x) + 1.0;
					    ...
					    u_xlat7.xyz = u_xlat12.xyz * vec3(u_xlat14);
				...
				SubProgram "d3d11 " {
					...
					void main()
					{
					    ...
					    u_xlat5.x = dot(vs_TEXCOORD1.xyz, u_xlat10_2.xyz);
					    u_xlat5.y = dot(vs_TEXCOORD2.xyz, u_xlat10_2.xyz);
					    u_xlat5.z = dot(vs_TEXCOORD3.xyz, u_xlat10_2.xyz);
					    ...
					    u_xlat5.xyz = vec3(_Float0) * u_xlat16_5.xyz + vec3(0.220916301, 0.220916301, 0.220916301);
					    u_xlat19 = (-_Float0) * 0.779083729 + 0.779083729;
					    u_xlat3.xyz = vec3(u_xlat19) * u_xlat10_3.xyz;
					    u_xlat16_19 = (-u_xlat10_4.x) + 1.0;
					    ...
					    u_xlat6.xyz = u_xlat10.xyz * vec3(u_xlat12);
					    u_xlat0.x = (-u_xlat0.x) + 1.0;
