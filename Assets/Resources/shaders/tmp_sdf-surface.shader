			...
			Program "fp" {
				SubProgram "d3d11 " {
					...
					void main()
					{
					    ...
					    u_xlat16_31 = (-u_xlat10_6.w) + 0.5;
					    u_xlat31 = u_xlat16_31 + (-vs_TEXCOORD5.x);
					    ...
					    if(u_xlatb32){
					        ...
					        u_xlat5.w = 1.0;
					        u_xlat6.x = dot(u_xlat10_8, u_xlat5);
					        u_xlat6.y = dot(u_xlat10_9, u_xlat5);
					        u_xlat6.z = dot(u_xlat10_7, u_xlat5);
					    } else {
					        u_xlat5.w = 1.0;
			...
			Program "fp" {
				SubProgram "d3d11 " {
					...
					void main()
					{
					    ...
					    u_xlat2 = texture(_MainTex, u_xlat2.zw);
					    u_xlat10_6 = texture(_MainTex, vs_TEXCOORD0.xy);
					    u_xlat16_25 = (-u_xlat10_6.w) + 0.5;
					    u_xlat25 = u_xlat16_25 + (-vs_TEXCOORD6.x);
					    ...
					    u_xlat10_7 = texture(_FaceTex, u_xlat12.xy);
					    u_xlat6 = u_xlat6 * u_xlat10_7;
					    u_xlat12.xy = vec2(_OutlineUVSpeedX, _OutlineUVSpeedY) * _Time.yy + vs_TEXCOORD1.xy;
					    u_xlat10_7 = texture(_OutlineTex, u_xlat12.xy);
					    u_xlat5.xyz = u_xlat10_7.xyz * _OutlineColor.xyz;
					    u_xlat7.w = u_xlat4.x * u_xlat10_7.w;
					    ...
					    u_xlat10_4 = texture(_LightTexture0, vec2(u_xlat27));
				...
				SubProgram "d3d11 " {
					...
					void main()
					{
					    ...
					    u_xlat27 = u_xlat27 * u_xlat10_5.w;
				...
				SubProgram "d3d11 " {
					...
					void main()
					{
					    ...
					    u_xlat26 = clamp(u_xlat26, 0.0, 1.0);
					    u_xlat27 = dot(u_xlat4.xyz, u_xlat4.xyz);
					    u_xlat10_5 = texture(_LightTextureB0, vec2(u_xlat27));
					    u_xlat10_4 = texture(_LightTexture0, u_xlat4.xyz);
					    u_xlat16_27 = u_xlat10_4.w * u_xlat10_5.x;
				...
				SubProgram "d3d11 " {
					...
					void main()
					{
					    ...
					    u_xlat2.x = u_xlat16 * u_xlat10_4.w;
					    u_xlat4.x = dot(vs_TEXCOORD2.xyz, (-u_xlat1.xyz));
					    u_xlat4.y = dot(vs_TEXCOORD3.xyz, (-u_xlat1.xyz));
					    u_xlat4.z = dot(vs_TEXCOORD4.xyz, (-u_xlat1.xyz));
					    u_xlat1.x = dot(u_xlat4.xyz, u_xlat4.xyz);
