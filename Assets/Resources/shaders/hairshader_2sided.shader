			...
			Program "fp" {
				...
				SubProgram "d3d11 " {
					...
					void main()
					{
					    ...
					    u_xlat2.x = u_xlat10_2.x + _Spec_Brightness;
					    u_xlat7.xy = vec2(vec2(_Spec_Contrast, _Spec_Contrast)) * vec2(1.0, -0.5) + vec2(0.0, 0.5);
					    u_xlat2.x = dot(u_xlat7.xy, u_xlat2.xx);
					    u_xlat2.x = max(u_xlat2.x, 0.0);
					    u_xlat2.x = min(u_xlat2.x, _MaxOriginalSpecular);
					    SV_Target1.w = u_xlat15 + u_xlat2.x;
					    SV_Target1.w = clamp(SV_Target1.w, 0.0, 1.0);
					    u_xlat15 = u_xlat10_1.w + (-_Cutoff);
					    ...
					    if(u_xlatb16){
					        ...
					        u_xlat16 = max(u_xlat16, u_xlat7.x);
