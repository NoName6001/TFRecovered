Shader "HairShader_T_Liz" {
	Properties {
		...
		_OpacityMul ("OpacityMul", Float) = 1
			...
			Program "fp" {
				SubProgram "d3d11 " {
					...
					void main()
					{
					    ...
					    SV_Target0.w = u_xlat10_6.w * _OpacityMul;
			...
			Program "fp" {
				SubProgram "d3d11 " {
					...
					void main()
					{
					    ...
					    u_xlat5.xy = vs_TEXCOORD0.xy * _TextureSample2_ST.xy + _TextureSample2_ST.zw;
					    u_xlat10_5 = texture(_TextureSample2, u_xlat5.xy);
					    u_xlat12.xy = vs_TEXCOORD0.xy * _TextureSample3_ST.xy + _TextureSample3_ST.zw;
					    u_xlat10_6 = texture(_TextureSample3, u_xlat12.xy);
					    SV_Target0.w = u_xlat10_6.w * _OpacityMul;
				...
				SubProgram "d3d11 " {
					...
					void main()
					{
					    ...
					    u_xlat10.xy = vs_TEXCOORD0.xy * _TextureSample3_ST.xy + _TextureSample3_ST.zw;
					    u_xlat10_5 = texture(_TextureSample3, u_xlat10.xy);
					    SV_Target0.w = u_xlat10_5.w * _OpacityMul;
