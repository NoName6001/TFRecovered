Shader "FaceShader_Male" {
	...
	SubShader {
		...
		Pass {
			Name "FORWARD"
			Tags { "IGNOREPROJECTOR" = "true" "LIGHTMODE" = "FORWARDBASE" "QUEUE" = "AlphaTest+0" "RenderType" = "TransparentCutout" "SHADOWSUPPORT" = "true" }
			GpuProgramID 23838
			Program "vp" {
				SubProgram "d3d11 " {
			...
			Program "fp" {
				SubProgram "d3d11 " {
					...
					void main()
					{
					    ...
					    u_xlat4.xy = vs_TEXCOORD0.xy * _ColorRT_ST.xy + _ColorRT_ST.zw;
					    u_xlat10_4 = texture(_ColorRT, u_xlat4.xy);
					    u_xlat5.xy = vs_TEXCOORD0.xy * _TextureSample0_ST.xy + _TextureSample0_ST.zw;
					    u_xlat10_5 = texture(_TextureSample0, u_xlat5.xy);
					    u_xlat6 = u_xlat10_5 + vec4(_Diffuse_Brightness);
					    u_xlat5.xy = vec2(_DifContrast) * vec2(1.0, -0.5) + vec2(0.0, 0.5);
					    u_xlat7.x = dot(u_xlat5.xy, u_xlat6.xw);
					    u_xlat7.y = dot(u_xlat5.xy, u_xlat6.yw);
					    u_xlat7.z = dot(u_xlat5.xy, u_xlat6.zw);
					    ...
					    u_xlat10_6 = texture(_WetnessRT, vs_TEXCOORD0.xy);
					    u_xlat16_40 = max(u_xlat10_6.w, 0.0);
					    u_xlat40 = min(u_xlat16_40, _FluidShininess);
					    u_xlat5.xy = vs_TEXCOORD0.xy * _Specular_ST.xy + _Specular_ST.zw;
					    u_xlat10_6 = texture(_Specular, u_xlat5.xy);
					    u_xlat41 = u_xlat10_6.x + _Spec_Brightness;
				...
				SubProgram "d3d11 " {
					...
					void main()
					{
					    ...
					    u_xlat4.xyz = clamp(u_xlat4.xyz, 0.0, 1.0);
					    u_xlat10_6 = texture(_WetnessRT, vs_TEXCOORD0.xy);
					    u_xlat16_43 = max(u_xlat10_6.w, 0.0);
					    u_xlat43 = min(u_xlat16_43, _FluidShininess);
					    u_xlat5.xy = vs_TEXCOORD0.xy * _Specular_ST.xy + _Specular_ST.zw;
					    u_xlat10_6 = texture(_Specular, u_xlat5.xy);
					    u_xlat44 = u_xlat10_6.x + _Spec_Brightness;
					    u_xlat5.xy = vec2(vec2(_Spec_Contrast, _Spec_Contrast)) * vec2(1.0, -0.5) + vec2(0.0, 0.5);
		...
		Pass {
			Name "FORWARD"
			Tags { "IGNOREPROJECTOR" = "true" "LIGHTMODE" = "FORWARDADD" "QUEUE" = "AlphaTest+0" "RenderType" = "TransparentCutout" "SHADOWSUPPORT" = "true" }
			...
			Program "fp" {
				SubProgram "d3d11 " {
					...
					void main()
					{
					    ...
					    u_xlat4.xyz = clamp(u_xlat4.xyz, 0.0, 1.0);
					    u_xlat10_6 = texture(_WetnessRT, vs_TEXCOORD0.xy);
					    u_xlat16_28 = max(u_xlat10_6.w, 0.0);
					    u_xlat28 = min(u_xlat16_28, _FluidShininess);
					    u_xlat5.xy = vs_TEXCOORD0.xy * _Specular_ST.xy + _Specular_ST.zw;
					    u_xlat10_6 = texture(_Specular, u_xlat5.xy);
					    u_xlat29 = u_xlat10_6.x + _Spec_Brightness;
					    u_xlat5.xy = vec2(vec2(_Spec_Contrast, _Spec_Contrast)) * vec2(1.0, -0.5) + vec2(0.0, 0.5);
					    ...
					    u_xlat10_5 = texture(_LightTexture0, vec2(u_xlat30));
					    u_xlat29 = u_xlat29 * u_xlat10_5.x;
					    u_xlat5.x = dot(vs_TEXCOORD1.xyz, u_xlat3.xyz);
					    u_xlat5.y = dot(vs_TEXCOORD2.xyz, u_xlat3.xyz);
					    u_xlat5.z = dot(vs_TEXCOORD3.xyz, u_xlat3.xyz);
					    u_xlat3.x = dot(u_xlat5.xyz, u_xlat5.xyz);
				...
				SubProgram "d3d11 " {
					...
					void main()
					{
					    ...
					    u_xlat3.xy = vs_TEXCOORD0.xy * _ColorRT_ST.xy + _ColorRT_ST.zw;
					    u_xlat10_3 = texture(_ColorRT, u_xlat3.xy);
					    u_xlat4.xy = vs_TEXCOORD0.xy * _TextureSample0_ST.xy + _TextureSample0_ST.zw;
					    u_xlat10_4 = texture(_TextureSample0, u_xlat4.xy);
					    u_xlat5 = u_xlat10_4 + vec4(_Diffuse_Brightness);
					    u_xlat4.xy = vec2(_DifContrast) * vec2(1.0, -0.5) + vec2(0.0, 0.5);
					    ...
					    u_xlat10_5 = texture(_WetnessRT, vs_TEXCOORD0.xy);
					    u_xlat16_25 = max(u_xlat10_5.w, 0.0);
					    u_xlat25 = min(u_xlat16_25, _FluidShininess);
					    u_xlat4.xy = vs_TEXCOORD0.xy * _Specular_ST.xy + _Specular_ST.zw;
					    u_xlat10_5 = texture(_Specular, u_xlat4.xy);
					    u_xlat26 = u_xlat10_5.x + _Spec_Brightness;
				...
				SubProgram "d3d11 " {
					...
					void main()
					{
					    ...
					    u_xlat30 = u_xlat30 * u_xlat10_6.w;
					    u_xlat31 = dot(u_xlat5.xyz, u_xlat5.xyz);
					    u_xlat10_5 = texture(_LightTextureB0, vec2(u_xlat31));
				...
				SubProgram "d3d11 " {
					...
					void main()
					{
					    ...
					    u_xlat29 = clamp(u_xlat29, 0.0, 1.0);
					    u_xlat30 = dot(u_xlat5.xyz, u_xlat5.xyz);
					    u_xlat10_6 = texture(_LightTextureB0, vec2(u_xlat30));
					    u_xlat10_5 = texture(_LightTexture0, u_xlat5.xyz);
					    u_xlat16_30 = u_xlat10_5.w * u_xlat10_6.x;
				...
				SubProgram "d3d11 " {
					...
					void main()
					{
					    ...
					    u_xlat26 = u_xlat26 * u_xlat10_4.w;
					    u_xlat4.x = dot(vs_TEXCOORD1.xyz, u_xlat2.xyz);
					    u_xlat4.y = dot(vs_TEXCOORD2.xyz, u_xlat2.xyz);
					    u_xlat4.z = dot(vs_TEXCOORD3.xyz, u_xlat2.xyz);
					    u_xlat2.x = dot(u_xlat4.xyz, u_xlat4.xyz);
				...
				SubProgram "d3d11 " {
					...
					void main()
					{
					    ...
					    u_xlat5.xy = vs_TEXCOORD0.xy * _ColorRT_ST.xy + _ColorRT_ST.zw;
					    u_xlat10_5 = texture(_ColorRT, u_xlat5.xy);
					    u_xlat6.xy = vs_TEXCOORD0.xy * _TextureSample0_ST.xy + _TextureSample0_ST.zw;
					    u_xlat10_6 = texture(_TextureSample0, u_xlat6.xy);
					    u_xlat7 = u_xlat10_6 + vec4(_Diffuse_Brightness);
					    u_xlat6.xy = vec2(_DifContrast) * vec2(1.0, -0.5) + vec2(0.0, 0.5);
					    u_xlat8.x = dot(u_xlat6.xy, u_xlat7.xw);
					    u_xlat8.y = dot(u_xlat6.xy, u_xlat7.yw);
					    u_xlat8.z = dot(u_xlat6.xy, u_xlat7.zw);
					    ...
					    u_xlat10_7 = texture(_WetnessRT, vs_TEXCOORD0.xy);
					    ...
					    u_xlat10_7 = texture(_Specular, u_xlat6.xy);
					    u_xlat32 = u_xlat10_7.x + _Spec_Brightness;
					    ...
					    u_xlat10_7 = texture(_LightTexture0, u_xlat22.xy);
					    u_xlat12.x = u_xlat12.x * u_xlat10_7.w;
					    u_xlat22.x = dot(u_xlat6.xyz, u_xlat6.xyz);
					    u_xlat10_6 = texture(_LightTextureB0, u_xlat22.xx);
					    u_xlat12.x = u_xlat12.x * u_xlat10_6.x;
				...
				SubProgram "d3d11 " {
					...
					void main()
					{
					    ...
					    u_xlat5.xyz = clamp(u_xlat5.xyz, 0.0, 1.0);
					    u_xlat10_7 = texture(_WetnessRT, vs_TEXCOORD0.xy);
					    u_xlat16_37 = max(u_xlat10_7.w, 0.0);
					    u_xlat37 = min(u_xlat16_37, _FluidShininess);
					    u_xlat6.xy = vs_TEXCOORD0.xy * _Specular_ST.xy + _Specular_ST.zw;
					    u_xlat10_7 = texture(_Specular, u_xlat6.xy);
					    u_xlat38 = u_xlat10_7.x + _Spec_Brightness;
					    u_xlat6.xy = vec2(vec2(_Spec_Contrast, _Spec_Contrast)) * vec2(1.0, -0.5) + vec2(0.0, 0.5);
				...
				SubProgram "d3d11 " {
					...
					void main()
					{
					    ...
					    u_xlat2.w = u_xlat26 * u_xlat27 + u_xlat10_5.x;
		...
		Pass {
			Name "ShadowCaster"
			Tags { "IGNOREPROJECTOR" = "true" "LIGHTMODE" = "SHADOWCASTER" "QUEUE" = "AlphaTest+0" "RenderType" = "TransparentCutout" "SHADOWSUPPORT" = "true" }
			GpuProgramID 149335
			Program "vp" {
				SubProgram "d3d11 " {
