			...
			Program "fp" {
				SubProgram "d3d11 " {
					...
					void main()
					{
					    ...
					    u_xlat5.x = dot(vs_TEXCOORD1.xyz, u_xlat10_3.xyz);
					    u_xlat5.y = dot(vs_TEXCOORD2.xyz, u_xlat10_3.xyz);
					    u_xlat5.z = dot(vs_TEXCOORD3.xyz, u_xlat10_3.xyz);
			...
			Program "fp" {
				...
				SubProgram "d3d11 " {
					...
					void main()
					{
					    ...
					    u_xlat4.x = dot(vs_TEXCOORD1.xyz, u_xlat10_2.xyz);
					    u_xlat4.y = dot(vs_TEXCOORD2.xyz, u_xlat10_2.xyz);
					    u_xlat4.z = dot(vs_TEXCOORD3.xyz, u_xlat10_2.xyz);
				...
				SubProgram "d3d11 " {
					...
					void main()
					{
					    ...
					    u_xlat10_4 = texture(_TextureSample1, u_xlat4.xy);
					    ...
					    u_xlat6.x = dot(vs_TEXCOORD1.xyz, u_xlat10_4.xyz);
					    u_xlat6.y = dot(vs_TEXCOORD2.xyz, u_xlat10_4.xyz);
					    u_xlat6.z = dot(vs_TEXCOORD3.xyz, u_xlat10_4.xyz);
			...
			Program "fp" {
				...
				SubProgram "d3d11 " {
					...
					void main()
					{
					    ...
					    u_xlat2.x = dot(vs_TEXCOORD1.xyz, u_xlat10_0.xyz);
					    u_xlat2.y = dot(vs_TEXCOORD2.xyz, u_xlat10_0.xyz);
					    u_xlat2.z = dot(vs_TEXCOORD3.xyz, u_xlat10_0.xyz);
					    u_xlat0.x = dot(u_xlat2.xyz, u_xlat2.xyz);
					    u_xlat0.x = inversesqrt(u_xlat0.x);
